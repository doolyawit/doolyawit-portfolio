...
export default function ContactMenuItem({ menuItems }: Props) {
  return (
    <div className={'flex w-full flex-1 flex-wrap justify-center gap-5 py-2 lg:flex-nowrap lg:gap-10 lg:p-4'}>
        ...
        return (
          <div key={index} className="group cursor-default text-center">
            <ExternalLink
              label={item.label}
              link={item.link}
              className="font-jk text-lg font-medium text-gray dark:text-beige md:text-xl lg:text-2xl"
            />
