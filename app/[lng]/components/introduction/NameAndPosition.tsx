...
export default async function NameAndPosition({ lng }: BaseProp) {
  ...
  return (
    <div className=" h-1/2 w-full xl:h-fit">
      ...
      <div className="flex w-full justify-center pt-4 text-center font-jk  text-5xl font-extrabold leading-normal text-gray selection:bg-green dark:text-beige dark:selection:bg-orange sm:px-20 sm:text-6xl sm:leading-relaxed lg:text-7xl xl:px-0 xl:pt-16 xl:text-head1">
        {t('doolyawit_yodkaew')}
      </div>
    </div>
  );
