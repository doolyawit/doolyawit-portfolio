...
function ToggleButton() {
  return (
    <div className="flex shrink grow basis-0 items-center justify-center gap-2.5 self-stretch">
      <div className="relative h-[69.25px] w-[112.83px]">
        <div className="absolute left-[21px] top-[20px] h-[30px] w-[70px]">
          ...
          <div className="bg-beige absolute left-[3.72px] top-[14.25px] h-[2.25px] w-[2.23px] rounded-full" />
        </div>
      </div>
    </div>
  );
